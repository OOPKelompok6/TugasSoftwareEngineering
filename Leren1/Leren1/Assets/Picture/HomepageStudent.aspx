<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Main.Master" AutoEventWireup="true" CodeBehind="HomepageStudent.aspx.cs" Inherits="Leren1.Pages.HomepageStudent" %>
   ...
   <div>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                        <asp:ImageButton ID="ImageButton9" runat="server" ImageUrl="../Assets/Picture/Shah.jpg" class="img-responsive center-block" OnClick="ImageButt_Click"/>
                        <div class="caption">
                            <h6>Shah</h6>
                        </div>
                    </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                        <asp:ImageButton ID="ImageButton10" runat="server" ImageUrl="../Assets/Picture/Pace.jpg" class="img-responsive center-block" OnClick="ImageButt_Click"/>
                        <div class="caption">
                            <h6>Pace Komputer</h6>
                        </div>
                    </div>
    ...
    <div>
         ...
         <div class="container">
            <div class="row text-center">
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                         <a href="https://akmalrusli363.github.io/smell/">
                             <img src="../Assets/Picture/Artikel.PNG"class="img-responsive center-block"/>
                         </a>
                        <div class="caption">
                            <h4>Code Re-Engineering: Smell Code</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
